...
const RestMenu = () => {
  ...
  const { name, areaName, costForTwoMessage, cuisines, avgRating, feeDetails ,sla} =
...
console.log(resInfo)
  ...
  return (
    <div className="text-center">
      ...
      <span className="font-bold my-6 text-2lg text-lightBlack">{sla.deliveryTime}MINS</span>
      <span className="font-bold my-6 text-2lg text-lightBlack m-5">{costForTwoMessage}</span>
